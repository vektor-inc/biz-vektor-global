...
function biz_vektor_get_default_theme_options(){
	$default_theme_options = array(
		...
		'pr1_image_s'          => get_template_directory_uri().'/images/samples/pr_image_demo_sq_1.gif',
		...
		'pr2_link'             => '',
		'pr2_image'            => get_template_directory_uri().'/images/samples/pr_image_demo_2.gif',
		'pr2_image_s'          => get_template_directory_uri().'/images/samples/pr_image_demo_sq_2.gif',
		...
		'pr3_link'             => '',
		'pr3_image'            => get_template_directory_uri().'/images/samples/pr_image_demo_3.gif',
		'pr3_image_s'          => get_template_directory_uri().'/images/samples/pr_image_demo_sq_3.gif',
		'version'              => '1.0.3',
		'SNSuse'               => false
	);
	for ( $i = 1; $i <= 5 ;){
