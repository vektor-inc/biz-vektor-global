...
function bizvektor_default_design_customize_register($wp_customize) {
	...
	$wp_customize->add_setting( 'biz_vektor_theme_options_default_design[theme_plusKeyColor]',	array('default' => '','type'=> 'option','capability' => 'edit_theme_options','sanitize_callback' => 'bizvektor_customize_sanitize_color' ) );
	$wp_customize->add_setting( 'biz_vektor_theme_options_default_design[theme_plusKeyColorLight]',	array('default' => '','type'=> 'option','capability' => 'edit_theme_options','sanitize_callback' => 'bizvektor_customize_sanitize_color' ) );
	$wp_customize->add_setting( 'biz_vektor_theme_options_default_design[theme_plusKeyColorDark]',	array('default' => '','type'=> 'option','capability' => 'edit_theme_options','sanitize_callback' => 'bizvektor_customize_sanitize_color' ) );
	// Create section UI
